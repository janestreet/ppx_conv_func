...
val lambda : Location.t -> pattern list -> expression -> expression

module Gen_sig : sig
  val generate
    :  extension_name:string
    -> nil:(tps:core_type list -> record_name:string -> Location.t -> 'new_record_sig)
    -> record:
         (tps:core_type list
          -> record_name:string
          -> Location.t
...
module Gen_struct : sig
  ...
  val make_body
    :  ?unique_f:(Location.t -> field_name:string -> field_ty:core_type -> expression)
    -> ?first_f:(Location.t -> field_name:string -> field_ty:core_type -> expression)
    -> ?last_f:(Location.t -> field_name:string -> field_ty:core_type -> expression)
    -> lds:label_declaration list
    -> init:expression
    -> Location.t
    -> (Location.t -> field_name:string -> field_ty:core_type -> expression)
    -> expression

  (** Create the anonymous pattern *)
  val anonymous : Location.t -> pattern
