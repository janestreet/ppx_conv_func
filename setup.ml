(* OASIS_START *)
(* DO NOT EDIT (digest: 5d14af7af0aa2f22161ff69c1b2a6604) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/ppx_conv_func";
          synopsis = "Deprecated";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\206bPl\231\134\165?\168\232\022\155N\213k]";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
